;Author: Eduardo
;Filename: mmx_xor_decoder.asm
;A XOR encoded program using mmx registers to decode previously XORed shellcode with a key.
...
decoder:
	...
	pop edi		  ; edi points to decoder_value
